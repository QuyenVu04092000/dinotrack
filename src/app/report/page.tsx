...
const Page = (): React.ReactElement => {
  return (
    <div className="p-4">
      <h1>Report</h1>
      Báo cáo . Color và Background CSS cung cấp nhiều cách để định nghĩa màu sắc và quản lý nền cho các phần tử, tạo
      nên phong cách và bố cục trực quan cho các trang web. 1. Color (Màu sắc) Màu sắc trong CSS có thể được áp dụng cho
      văn bản, đường viền, bóng, và nhiều yếu tố khác. Bạn có thể sử dụng các phương pháp định nghĩa màu sắc như: Tên
      màu (Color Names): CSS hỗ trợ nhiều tên màu có sẵn như red, blue, green, black, white, v.v. Ví dụ: color: red; Mã
      màu HEX: Biểu diễn màu bằng mã HEX với dấu # theo sau là sáu ký tự hexadecimals. Ví dụ: color: #ff0000; (màu đỏ)
      RGB và RGBA: Sử dụng hệ màu RGB (Red, Green, Blue), giá trị trong khoảng 0-255. RGBA thêm giá trị alpha để chỉ
      định độ trong suốt (0 là trong suốt, 1 là không trong suốt). Ví dụ: color: rgb(255, 0, 0); (màu đỏ) Ví dụ: color:
