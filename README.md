...
- Clone the repo
  ...
  ```sh
  git clone https://gitlab.com/mltechsoftproject/dms-v2-web-admin.git
  ```
...
- folders in app (routing) -> kebab case
- files in other folders -> camel case
...
│   └── image                # Image used by default template
│       └── png
│       └── jpg
│       └── svg
├── src
...
|   ├── hooks                 # Custom hooks (naming & structure same components)
│   ├── services              # Separate logic modules (naming & structure same components)
...
I(<Name>)(<Suffix>)
│    │        │
│    │        └─⫸Suffix: Suffix indicating the purpose or role of the interface: Props|Data|Response|Request
│    │
│    └─⫸ Name: Represents the type of data or component that the interface describes
│
└─⫸ Prefix: Prefix indicating that it's an interface. Represents the type of data or component that the interface describes

```

#### Name

With interfaces for component props, Name must be the name of the component
...
- **Data**: General data.
- **Props**: Props passed into a component.
- **Response**: Data returned from an API.
- **Request**: Data sent in a request.

Note: Denotes shared or widely applicable characteristics across different contexts or components remove the suffix part.

Examples:

- `IUserData`: Interface describing user data.
- `ILoadingFrameProps`: Interface describing props for the LoadingFrame component.
- `IUserResponse`: Interface describing data returned from an API regarding users.
- `IGetUserRequest`: Interface describing data sent for request get user.
- `IUserProfile`: Interface may be describing data returned from an API regarding user profile or describing data user profile for UserProfileFrame component (remove the suffix part)
